...
\subsection{1.1 - Carga de red}
Se crea una visualización de la red de Polimá Westcoast mediante Pyvis, utilizada en la tarea 1. Polimá Westcoast es un artista Chileno que se enfoca principalmente en el género urbano.
...
\subsection{1.4 - Análisis de comunidades de Louvain}
...
\subsection{2.4 - Análisis de resultados de K-means}
